...
<div style="width: 600px;">
    <table id="CountTable" style="width:600px;">
...
<script>
    ...
    function getResult() {
        ...
        //实现文件超链接
        document.getElementById("downloadHref").href = "/SZFC2/download?filename=" + startDate + "," + endDate + ".xls&startDate=" + startDate + "&endDate=" + endDate + "&type=dealLocation";
    ...
    function showWechatArticle(response) {
        ...
        var text = yesterdayDate + '号新房共计成交' + (zhu + feizhu) + '套，成交面积' +  parseFloat(Number(areaAll).toFixed(2)) + '平方米<br>'
