...
<div style="width: 600px;">
    <table id="queryStockCount" style="width:600px;">
    ...
    function getResult() {
        ...
        layui.use('table', function () {
            ...
            table.render({ //其它参数在此省略
                ...
                url: '/SZFC2/queryStockCount',
                where: {'startDate': startDate, 'endDate': endDate}
            });
        });

        //实现文件超链接
        document.getElementById("downloadHref").href="/SZFC2/download?filename="+startDate+","+endDate+".xls&startDate="+startDate+"&endDate="+endDate+"&type=canStockDealLocation";
